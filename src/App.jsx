...
async function stitchImages(imgDataUrls, maxWidth = 1024) {
...
export default function App() {
  ...
  const BATCH_SIZE = activeApi === "gemini" ? 6 : 8;
  ...
  const processFile = async file => {
    ...
    try {
      ...
      for (let batchIdx = 0; batchIdx < numBatches; batchIdx++) {
        ...
        // Delay between batches (only needed for Gemini free tier)
        if (batchIdx < numBatches - 1 && activeApi === "gemini") {
          addLog(`   ⏱  Waiting 5s before next batch…`);
