...
// ─── Claude translation ────────────────────────────────────────────────────
async function translatePage(b64) {
...
function drawTranslations(canvas, img, bubbles) {
  ...
  for (const b of bubbles) {
    ...
    ctx.fillStyle = isDark ? "#000" : b.style === "caption" ? "#f4efdf" : "#fff";
...
export default function App() {
  ...
  const [viewerWidth, setViewerWidth] = useState(100); // percentage on mobile
  ...
  const processFile = useCallback(async file => {
    ...
    try {
      ...
      for (let i = 0; i < imageFiles.length; i++) {
        ...
        let bubbles = [];
        try {
          const r = await translatePage(b64);
          bubbles = r.bubbles || [];
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: 16 }}>
          ...
          <div style={{ display: "flex", gap: 10, marginBottom: 16 }}>
            <button
              ...
              style={{
                ...
                fontSize: 16, letterSpacing: 3, cursor: "pointer", borderRadius: 4,
              }}
            >
              📖 READ MANGA
            </button>
        ...
        {pages.length === 0 && status === "idle" && (
          <div style={{ textAlign: "center", padding: "40px 0", color: "#2a2a2a" }}>
            ...
            <div style={{ fontSize: 11, letterSpacing: 3, marginTop: 8 }}>
              OPEN A CBZ FILE TO BEGIN
            </div>
          </div>
        )}
      </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "Bangers, cursive", fontSize: 22, letterSpacing: 4, color: "#d4a017" }}>
          漫画
        </span>
        <span style={{ fontFamily: "Bangers, cursive", fontSize: 14, color: "#555", letterSpacing: 2 }}>
          TRANSLATOR
        </span>
          ...
          {["upload", "reader"].map(v => (
            <button
              ...
              style={{
                ...
                color: view === v ? "#000" : pages.length === 0 && v === "reader" ? "#333" : "#777",
                border: "1px solid " + (view === v ? "#d4a017" : "#333"),
